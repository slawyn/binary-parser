...
extern uint32_t ui32ConvertHexNibbleToUint(char cHex);
extern uint8_t ui32ConvertHexStringToByte(char *sHexNibbles);
extern uint16_t ui32ConvertHexStringToWord(char *sHexNibbles);
